...
class Venda
{
    ...
    // Salva um venda no BD com os dados da View
    public static function salvar($dados)
    {
        try {
            ...
            $sql = "INSERT INTO vendas (nome, cpf, data_nascimento, celular, rua, numero, complemento, bairro, cidade, cep, estado, email, tipo, senha) ";
    ...
    public static function atualizar($dados)
    {
        try {
            ...
            $stmt->bindParam(":id", $dados['id_venda'], PDO::PARAM_INT);
